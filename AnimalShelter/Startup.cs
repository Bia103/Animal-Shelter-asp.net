...
namespace AnimalShelter
{
    public partial class Startup
    {
        ...
        private void CreateAdminAndUserRoles()
        {
            ...
            if (!roleManager.RoleExists("Voluntar"))
            {
                ...
                //var user = new ApplicationUser();
                user.UserName = "voluntar@voluntar.com";
                user.Email = "voluntar@voluntar.com";

                var adminCreated = userManager.Create(user, "Voluntar2020!");
                if (adminCreated.Succeeded)
                {
                    userManager.AddToRole(user.Id, "Voluntar");
                }
            }
        }
    }
